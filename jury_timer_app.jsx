          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-600 md:text-base">
                Communication Design • Semester 06 • 14 minutes per student
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              <Badge className="rounded-full px-4 py-1 text-sm">4 Subjects × 3 min</Badge>
          ...
          <Card className="rounded-3xl border-0 shadow-sm">
            ...
            <CardContent>
              ...
              <div className="mt-6 rounded-2xl bg-slate-50 p-4 text-sm text-slate-600 ring-1 ring-slate-200">
                ...
                Problem 30 sec • Solution 30 sec • Outcomes 60 sec • Q&A 60 sec
              </div>
            </CardContent>
          </Card>
        </div>
